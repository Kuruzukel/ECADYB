...
<head>
  ...
  <link href="/ECADYB/Admin/Departments/assets/css/Tourism.css" rel="stylesheet">
</head>
  ...
  <div class="container">
    <div class="catalog-root">
      <div class="catalog-app">
        <iframe src="/ECADYB/Admin/Yearbook/index.html?department=BSTM" width="100%" height="100%"
    ...
    <script src="/ECADYB/Admin/Departments/assets/js/Tourism.js"></script>
  </div>
</body>
