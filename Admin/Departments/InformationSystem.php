...
<head>
    ...
    <link href="/ECADYB/Admin/Departments/assets/css/InformationSystem.css" rel="stylesheet">
</head>
    ...
    <div class="container">
        <div class="catalog-root">
            <div class="catalog-app">
                <iframe src="/ECADYB/Admin/Yearbook/index.html?department=BSIS" width="100%" height="100%"
        ...
        <script src="/ECADYB/Admin/Departments/assets/js/InformationSystem.js"></script>
    </div>
</body>
