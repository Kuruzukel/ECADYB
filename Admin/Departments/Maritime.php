...
<head>
  ...
  <link href="/Admin/Departments/assets/css/Maritime.css" rel="stylesheet">
</head>
  ...
  <div class="container">
    <div class="catalog-root">
      <div class="catalog-app">
        <iframe src="/Admin/Yearbook/index.html?department=BSME" width="100%" height="100%"
    ...
    <script src="/Admin/Departments/assets/js/Maritime.js"></script>
  </div>
</body>
