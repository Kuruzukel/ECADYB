...
<head>
    ...
    <link href="<?= $basePath ?>/Admin/Departments/assets/css/Nursing.css" rel="stylesheet">
</head>
    ...
    <div class="container">
        <div class="catalog-root">
            <div class="catalog-app">
                <iframe src="<?= $basePath ?>/Admin/Yearbook/index.html?department=BSN" width="100%" height="100%"
        ...
        <script src="<?= $basePath ?>/Admin/Departments/assets/js/Nursing.js"></script>
    </div>
</body>
